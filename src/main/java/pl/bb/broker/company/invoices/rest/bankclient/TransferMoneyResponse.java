...
public class TransferMoneyResponse {
    ...
    @XmlElementRef(name = "transferMoneyResult", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transferMoneyResult;
     ...
     *     
     */
    public JAXBElement<String> getTransferMoneyResult() {
     ...
     *     
     */
    public void setTransferMoneyResult(JAXBElement<String> value) {
