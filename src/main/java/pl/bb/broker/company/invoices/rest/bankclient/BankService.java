 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:58671/BattleService.svc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:58671/BattleService.svc?wsdl");
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IBankService")
    public IBankService getBasicHttpBindingIBankService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IBankService"), IBankService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IBankService")
    public IBankService getBasicHttpBindingIBankService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IBankService"), IBankService.class, features);
    }
